...
header("Content-Disposition:attachmet;filename=reporte-factura.xls");
*/
?>
<?php
$c = new Conexion();
                          ...
                          <table class="table table-bordered table-s" width="100%">
                             <thead>
                               <tr>
                                   ...
                                   <th style="width:9%">Tipo de Pago</th>
                                   <th style="width:9%">Fecha</th>
                                   <th style="width:9%">CoatEnvio</th>
                                   <th style="width:9%">ValorFactura</th>
                                   </tr>         
                                         </thead>
                                         <?php
                                         if($arreglos>0){
