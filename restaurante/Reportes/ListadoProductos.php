...
<body>
       ...
       <div class="card">
                      <h5 class="card-header">Reporte de Productos</h5>
                      <div class="card-body">
                          <div class="row">
                          <table class="table table-bordered table-s" width="100%">
                             <thead>
                               <tr>
                                   ...
                                   <th style="width:9%">Valor Producto</th>
                                   <th style="width:9%">Cantidad</th>
                                   <th style="width:9%">Total</th>
                                   <th style="width:9%">IdCategoria</th>
                                   <th style="width:9%">IdProveedor</th>
                                   </tr>         
                                         </thead>
                                         <?php
                                         if($arreglos>0){
                                   ...
                                   <tbody>
                                       <tr>
                                           ...
                                           <td><?php echo $arreglos[2]  ?></td>
                                           <td><?php echo $arreglos[3]  ?></td>
                                           <td><?php echo $arreglos[4]  ?></td>
                                           <td><?php echo $arreglos[5]  ?></td>
                                           <td><?php echo $arreglos[6]  ?></td>
                                       </tr>
