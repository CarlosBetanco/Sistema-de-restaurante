          ...
          <center>
              ...
              <table class="table-bordered">
                          ...
                          <td style="width:800px" class="text-light" colspan="4">Información del Producto</td>
                           ...
                           <tr>
                              <td>Codigo</td>
                              <td><input readOnly size="10" type="Int" name="IdTipoPago" id="IdTipoPago" value="<?php echo $obj->IdTipoPago?>" placeholder="Código es Automatico"></td>
                          </tr>
                          <tr>
                              <td>Metodo de pago</td>
                              <td><input  readOnly size="40" type="text" name="Descripcion_Pago" id="Descripcion_Pago" value="<?php echo $obj->Descripcion_Pago  ?>" placeholder="Nombre del pago"></td>
                          </tr>
