...
if(isset($_POST['consulta'])){
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select producto.IdProducto, producto.NombreProducto, producto.ValorProducto, categorias.NombreCategoria , producto.Cantidad, producto.IvaProducto, producto.TotalProductos from producto inner join categorias on producto.IdCategorias = categorias.IdCategorias where producto.NombreProducto like '%$obj->NombreProducto%' ";
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select producto.IdProducto, producto.NombreProducto, producto.ValorProducto, categorias.NombreCategoria , producto.Cantidad, producto.IvaProducto, producto.TotalProductos from producto inner join categorias on producto.IdCategorias = categorias.IdCategorias order by NombreProducto";
                                $limite =sprintf("%s limit %d, %d",$sql, $inicia, $maximoDatos);
                                $resultado = mysqli_query($cone,$limite);
                                $arreglo = mysqli_fetch_row($resultado);
        ...
        <center>
          <br>   
            ...
            <table >
                 <tr>
                    <td>
                             <a  href="ProductoAgregar.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true">Agregar</i></button>
                            </a>
                    </td>
                </tr>
                 <tr>
		                <th><label for="promocion">Buscar</label></th>
		                <th><input style="font-size:12px" type="text" id="NombreProducto" name="NombreProducto"   placeholder="Digite el nombre del producto " size="50" >
            ...
            <center>
                <table class= "table  table-bordered table-hover table-sm"  style="width:90%">
                        ...
                        <thead>
                            <tr class="table-dark">
                                <th scope="col" style="width:10%"  class="">IdProducto</th>
                                <th scope="col" style="width:10%"  class="">NombreProducto</th>
                                <th scope="col" style="width:15%" class="">ValorProducto</th>
                                <th scope="col" style="width:15%" class="">IdCategoria</th>
                                <th scope="col" style="width:15%" class="">Cantidad</th>
                                <th scope="col" style="width:15%" class="">Iva</th>
                                <th scope="col" style="width:15%" class="">TotalProductos</th>
                                <th scope="col" style="width:15%" class="">Imagen</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo number_format ($arreglo[2]) ?></td>
                                ...
                                <td>
                                    <center>
                                           <img  src="<?php echo $arreglo[8] ?>" width="80" height="70">
                                      </center>
                                </td>
                                
                                <td class="letra">
                                <a href="<?php if($arreglo[0] <> ""){
                        echo "ProductoModificar.php?key=".urlencode($arreglo[0]);
                        } else{
                         ...
                         ?>">
                            <button name="Guarda" type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true">Modificar</i></button>
                                ...
                                <td class="letra">
                                <a href="<?php if($arreglo[0]<>""){
                                            echo "ProductoEliminar.php?key=".urlencode($arreglo[0]);
                                    }else{
