...
if(isset($_POST['consulta'])){
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from usuarios where  NombreUsuario LIKE '%$obj->NombreUsuario%'";
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from usuarios order by NombreUsuario";
                                $limite =sprintf("%s limit %d, %d",$sql, $inicia, $maximoDatos);
                                $resultado = mysqli_query($cone,$limite);
                                $arreglo = mysqli_fetch_row($resultado);
...
<html lang="es">
    ...
    <body>
        ...
        <center>
          <br>   
            <h3 class=" text-danger font-weight-normal  " >Usuarios</h3> 
            <hr style="height:1px;border:none;color:#333;background-color:#333;">
            <form name="Detalle" action="" method="POST">
            <table >
                 <tr>
                    <td>
                             <a  href="UsuariosAgregar.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true">Agregar</i></button>
                            </a>
                    </td>
                </tr>
                 <tr>
		                <th><label for="promocion">Buscar</label></th>
		                <th><input style="font-size:12px" type="text" id="NombreUsuario" name="NombreUsuario"   placeholder="Digite el Nombre del Usuario " size="50" >
            ...
            <center>
                <table class= "table  table-bordered table-hover table-sm"  style="width:90%">
                        <caption><small>Lista de Usuarios</small></caption>  
                        <thead>      
           
            
            <tr class="bg-dark">
                <th scope="col" style="width:15%"  class="text-light letra">NombreUsuario</th>
                <th scope="col" style="width:15%"  class="text-light letra">ClaveUsuario</th>
                <th scope="col" style="width:15%" class="text-light letra">IdRol</th>
                <th scope="col" style="width:15%" class="text-light letra">Imagen</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="arreglo2"><?php echo $arreglo[2] ?></td>
                <td>
                         <center>
                         <img  src="<?php echo $arreglo[3] ?>" width="80" height="70">
                         </center>
                     </td>
                
                <td class="letra">
                                <a href="<?php if($arreglo[0] <> ""){
                        echo "UsuariosModificar.php?key=".urlencode($arreglo[0]);
                        } else{
                         ...
                         ?>">
                            <button name="Guarda" type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true">Modificar</i></button>
                                ...
                                <td class="letra">
                                <a href="<?php if($arreglo[0]<>""){
                                            echo "UsuariosEliminar.php?key=".urlencode($arreglo[0]);
                                    }else{
