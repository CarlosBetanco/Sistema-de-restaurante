...
if(isset($_POST['consulta'])){
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from roles where  IdRol LIKE '%$obj->IdRol%'";
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from roles order by IdRol";
                                $limite =sprintf("%s limit %d, %d",$sql, $inicia, $maximoDatos);
                                $resultado = mysqli_query($cone,$limite);
                                $arreglo = mysqli_fetch_row($resultado);
...
<html lang="es">
    ...
    <body>
        ...
        <center>
          <br>   
            <h3 class=" text-danger font-weight-normal  " >Roles</h3> 
            <hr style="height:1px;border:none;color:#333;background-color:#333;">
            <form name="Detalle" action="" method="POST">
            <table >
                 <tr>
                    <td>
                             <a  href="RolesAgregar.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true">Agregar</i></button>
                            </a>
                    </td>
                </tr>
                 <tr>
		                <th><label for="promocion">Buscar</label></th>
		                <th><input style="font-size:12px" type="text" id=" IdRol" name="IdRol"   placeholder="Digite el ID del Rol " size="50" >
            ...
            <center>
                <table class= "table  table-bordered table-hover table-sm"  style="width:90%">
                        <caption><small>Lista de Roles</small></caption>  
                        <thead>
                            <tr class="table-dark">
                                <th scope="col" style="width:10%"  class="">IdRoles</th>
                                <th scope="col" style="width:10%"  class="">NombreRol</th>
                        ...
                        echo "RolesModificar.php?key=".urlencode($arreglo[0]);
                        } else{
                         ...
                         ?>">
                            <button name="Guarda" type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true">Modificar</i></button>
                                ...
                                <td class="letra">
                                <a href="<?php if($arreglo[0]<>""){
                                            echo "RolesEliminar.php?key=".urlencode($arreglo[0]);
                                    }else{
                ...
                <ul class="pagination pagination-sm">
                 ...
                 <li class="page-item">
                   ...
                   <li class="page-item active">
                    ...
                    if($paginaNumero < $totalPagina ){
                    ?> 
                   <a class="page-link" href="<?php echo $paginaNumero; ?>" id="paginador"><i class="fa fa-angle-right"></i>></a></li>
                   <?php }?>
                  </ul>
                </nav>
                    </td>
