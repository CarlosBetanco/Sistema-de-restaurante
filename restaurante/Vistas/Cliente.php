...
if(isset($_POST['consulta'])){
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from cliente where  Nombre LIKE '%$obj->Nombre%'";
...
<html lang="es">
    ...
    <body>
        ...
        <center>
          <br>   
            <h3 class=" text-danger font-weight-normal  " >Clientes </h3> 
            <hr style="height:1px;border:none;color:#333;background-color:#333;">
            <form name="Detalle" action="" method="POST">
            <table >
                 <tr>
                    <td>
                             <a  href="Clientesagregar.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true">Agregar</i></button>
                            </a>
                    </td>
                </tr>
                 <tr>
		                <th><label for="promocion">Buscar</label></th>
		                <th><input style="font-size:12px" type="text" id="Nombre" name="Nombre"   placeholder="Digite  el nombre del Cliente " size="50" >
                            <button type="submit" name="consulta" class="btn btn-warning btn-sm" ><i class="fa fa-search" aria-hidden="true">Consultar</i></button>
		                    <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-undo" aria-hidden="true">Refrescar</i></button></th>
		                <th><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-sign-out" aria-hidden="true">Salir</i></button></th>
                        <a href="../Reportes/ListadoClientes.php">
            ...
            <tr class="bg-dark">
                ...
                <th scope="col" style="width:15%"  class="text-light letra">Cliente</th>
                <th scope="col" style="width:15%"  class="text-light letra">TipoDocumento</th>
                <th scope="col" style="width:15%" class="text-light letra">Nombre</th>
                <th scope="col" style="width:10%" class="text-light letra">Apellido</th>
                <th scope="col" style="width:10%" class="text-light letra">Telefono</th>
                <th scope="col" style="width:10%" class="text-light letra">Correo</th>
                <th scope="col" style="width:10%" class="text-light letra">Modificar</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="letra">
                        ...
                        echo "ClienteModificar.php?key=".urlencode($arreglo[0]);
                        } else{
                         ...
                         ?>">
                            <button name="Guarda" type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true">Modificar</i></button>
                                ...
                                <td class="letra">
                                <a href="<?php if($arreglo[0]<>""){
                                            echo "ClienteEliminar.php?key=".urlencode($arreglo[0]);
                                    }else{
