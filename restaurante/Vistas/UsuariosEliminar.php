...
$llave = $_GET['key'];
  ...
  if($arreglo = mysqli_fetch_row($resultado)){
    ...
    $obj->IdRol= $arreglo[2];
      ...
      $obj->NombreUsuario = null;
      $obj->ClaveUsuario = null;
      $obj->IdRol = null;
  ...
  <html lang="es">
      ...
      <body>
          <center>
              ...
              <h4 class=" text-danger font-weight-normal " >Eliminar Usuarios</h4><br> 
              ...
              <tr class="bg-dark" >
                       <td style="width:800px" class="text-light" colspan="4">Información del Producto</td>
                          ...
                          <tr>
                              <td>NombreUsuario</td>
                              <td><input readOnly size="10" type="Int" name="NombreUsuario" id="NombreUsuario" value="<?php echo $obj->NombreUsuario?>" placeholder="Código es Automatico"></td>
                          </tr>
                          <tr>
                              <td>ClaveUsuario</td>
                              <td><input  readOnly size="40" type="text" name="ClaveUsuario" id="ClaveUsuario" value="<?php echo $obj->ClaveUsuario  ?>" placeholder="Nombre del pago"></td>
                          </tr>
                          <tr>
                              <td>IdRol</td>
                              <td><input  readOnly size="40" type="text" name="IdRol" id="IdRol" value="<?php echo $obj->IdRol ?>" placeholder="Nombre del pago"></td>
                          </tr>
