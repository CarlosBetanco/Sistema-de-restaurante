...
if(isset($_POST['consulta'])){
                                ...
                                $c = new Conexion();
                                $cone = $c->conectando();
                                $sql = "select * from  categorias  where NombreCategoria LIKE '%$obj->NombreCategoria%'";
        ...
        <center>
          <br>   
            ...
            <table >
                 <tr>
                    <td>
                             <a  href="CategoriaAgregar.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true"></i>agregar</button></a>
                    </td>
                </tr>
                 <tr>
		                <th><label for="categorias">Buscar</label></th>
		                <th><input style="font-size:12px" type="text" id="NombreCategoria" name="NombreCategoria"   placeholder="Digite  el nombre de la Categoria " size="50" >
            ...
            <center>
                ...
                <table class="table  table-bordered table-hover table-sm " style="width:90%">
                        <caption><small>Lista de Categoria</small></caption>  
                        <thead>
                            <tr class="bg-dark">
                                <th scope="col" style="width:10%"  class="text-light letra">IdCategorias</th>
                                <th scope="col" style="width:15%" class="text-light letra">NombreCategoria</th>
                        ...
                        echo "CategoriaModificar.php?key=".urlencode($arreglo[0]);
                        } else{
