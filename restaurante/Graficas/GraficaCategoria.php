...
<body>
    ...
    <h4 class=" text-danger font-weight-normal text-center" >Grafica de Categorias</h4><br>
        <div class="row">
            <div class="col-lg-6">
            <canvas id="pie-chart" width="600" height="100"></canvas>
            </div>    
        </div>
    </div>
    <br>
...
new Chart(document.getElementById("pie-chart"), {
    ...
    data: {
      labels: [<?php
        ...
        ?>
        '<?php echo $arreglo["NombreCategoria"];?>',
        <?php
              }
        ?>],
      datasets: [{
